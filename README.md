...
Install beta version via `devtools::install_github("fanzheng10/HiSig", subdir="HiSig")`. See basic usage [here](https://github.com/fanzheng10/HiSig/HiSig/examples/main.R). More documents and vignettes are under construction. 
